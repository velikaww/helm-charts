...
{{- define "app.pvc.sshd.name" -}}
    {{- if and .Values.pvc .Values.pvc.sshd .Values.pvc.sshd.nameOverride -}}
        {{- print .Values.pvc.sshd.nameOverride -}}
    {{- else -}}
        {{- printf "%s-sshd" (include "app.fullname" .) -}}
    {{- end -}}
{{- end -}}
{{- define "app.pvc.ssh.name" -}}
    {{- if and .Values.pvc .Values.pvc.ssh .Values.pvc.ssh.nameOverride -}}
        {{- print .Values.pvc.ssh.nameOverride -}}
    {{- else -}}
        {{- printf "%s-ssh" (include "app.fullname" .) -}}
    {{- end -}}
{{- end -}}
{{- define "app.pvc.data.name" -}}
    {{- if and .Values.pvc .Values.pvc.data .Values.pvc.data.nameOverride -}}
        {{- print .Values.pvc.data.nameOverride -}}
    {{- else -}}
